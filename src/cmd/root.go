...
func init() {
	...
	//rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.mayfly.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".mayfly" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".mayfly")
	}
